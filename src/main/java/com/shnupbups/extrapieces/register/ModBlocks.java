...
public class ModBlocks {
	...
	public static void generateDefaultSets() {
		...
		GOLD_PIECES = PieceSets.createSet(Blocks.GOLD_BLOCK, "gold").register();
		IRON_PIECES = PieceSets.createSet(Blocks.IRON_BLOCK, "iron").register();
		DIAMOND_PIECES = PieceSets.createSet(Blocks.DIAMOND_BLOCK, "diamond").register();
		EMERALD_PIECES = PieceSets.createSet(Blocks.EMERALD_BLOCK, "emerald").register();
		REDSTONE_PIECES = PieceSets.createSet(Blocks.REDSTONE_BLOCK, "redstone").register();
		COAL_PIECES = PieceSets.createSet(Blocks.COAL_BLOCK, "coal").register();
		LAPIS_LAZULI_PIECES = PieceSets.createSet(Blocks.LAPIS_BLOCK, "lapis_lazuli").register();
		...
		FIRE_CORAL_PIECES = PieceSets.createSet(Blocks.FIRE_CORAL_BLOCK, "fire_coral").register();
