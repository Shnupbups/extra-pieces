...
public class ModBlocks {
	...
	public static void generateDefaultSets() {
		...
		PETRIFIED_OAK_PIECES = PieceSets.createSet(Blocks.PETRIFIED_OAK_SLAB, "petrified_oak", PieceType.SIDING).addVanillaPiece(PieceType.SLAB, Blocks.PETRIFIED_OAK_SLAB).setTexture("oak_planks").setHasCustomTranslation().setInclude().register();
